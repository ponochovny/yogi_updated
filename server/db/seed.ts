...
import ws from 'ws'
import { globalCategories, globalCurrencies, globalTypes } from './schema/global'
...
async function seedGlobalData() {
	...
	const db = drizzle(pool, { schema: { globalCategories, globalTypes, globalCurrencies } })
	...
	console.log('Seed completed for global categories, global types, and global currencies.')
}
