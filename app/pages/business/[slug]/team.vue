...
const save = async (member: Member) => {
  ...
  delete editing.value[member.linkId]
  await refresh()
    ...
    <section class="space-y-3">
      ...
      <div class="overflow-x-auto rounded-lg border">
        <Table
          ><TableHeader
            ><TableRow
              ><TableHead>Trainer</TableHead><TableHead>Status</TableHead
              ><TableHead>Commercial terms</TableHead><TableHead>Rate</TableHead
                ...
                ><template v-if="editing[member.linkId]"
                  ><NativeSelect
                    ...
                    ><NativeSelectOption value="FLAT_RATE"
                      >Flat Rate / class</NativeSelectOption
                    ><NativeSelectOption value="PER_ATTENDEE"
                      >Per Attendee</NativeSelectOption
                    ><NativeSelectOption value="REVENUE_SHARE"
                      >Revenue Share</NativeSelectOption
                    ></NativeSelect
                  ></template
              ...
              ><TableCell class="space-x-2"
                ><template v-if="editing[member.linkId]"
                  ...
                  ><Button
                    size="sm"
                    variant="ghost"
                    @click="delete editing[member.linkId]"
                    >Cancel</Button
                  ></template
                ><template v-else
        ...
        <Table
          ><TableHeader
            ><TableRow
              ...
              ><TableHead class="text-right">Accrued</TableHead></TableRow
            ></TableHeader
          ><TableBody
            ><TableRow
            ...
            ><TableRow v-if="!data?.payroll?.length"
              ><TableCell
                ...
                >No payroll entries for this month.</TableCell
              ></TableRow
            ></TableBody
          ></Table
        >
