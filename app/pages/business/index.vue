...
import DashboardTrendingCard from './[slug]/_components/DashboardTrendingCard.vue'
...
<template>
  <div class="@container/main w-full space-y-6">
    <template v-if="userData.roles.includes(userRoles.BUSINESS)">
      <div
